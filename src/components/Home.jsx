    ...
    <div className="px-12">
      <div className="border-[3px] rounded-3xl border-gray-900 flex justify-between items-center mb-7 p-7">
        <div className="w-full flex items-center justify-between ">
          ...
          <Input
            type="text"
            className="text-black w-96 cursor-pointer"
            placeholder="Search"
            value={searchInput}
            onChange={(event) => {
              ...
              posts.map((post) => (
                ...
                >
                  <div className="w-full h-auto flex justify-center">
                    {post.content?.toLowerCase().includes("jpg") ||
                    post.content?.toLowerCase().includes("png") ||
                    post.content?.toLowerCase().includes("gif") ? (

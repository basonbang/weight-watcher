          ...
          {posts.map((post) => (
            ...
            >
              <div className='w-full h-auto'>
                <svg viewBox="0 0 363 219" fill="none" xmlns="http://www.w3.org/2000/svg"> 
                  <path d="M219.312 18.25H90.75C82.7272 18.25 75.033 20.1728 69.36 23.5953C63.687 27.0178 60.5 31.6598 60.5 36.5V182.5C60.5 187.34 63.687 191.982 69.36 195.405C75.033 198.827 82.7272 200.75 90.75 200.75H272.25C280.273 200.75 287.967 198.827 293.64 195.405C299.313 191.982 302.5 187.34 302.5 182.5V68.4375L219.312 18.25Z" stroke="#F2F0E8" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                  <path d="M211.75 18.25V73H302.5" stroke="#F2F0E8" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                  <path d="M151.25 100.375L226.875 127.75L151.25 155.125V100.375Z" stroke="#F2F0E8" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
              ...
              <div className='bg-[#09090B] flex-grow px-1 py-2 rounded-xl flex flex-col justify-around'>
                ...
                <div className="flex mt-2">
                  ...
                  <p className='font-medium text-sm ml-2'>{post.likes} upvotes</p>
                </div>
              </div>
            </Link>
          ))}
